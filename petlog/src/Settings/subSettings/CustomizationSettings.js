...
export default function ProfileSettings() {
  ...
  return (
    <div className={classes.root}>
      ...
      <Typography className={classes.sectionHeading}>Customization</Typography>
      ...
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
            ...
            <AccordionActions>
                ...
                <Button size="small" color="primary" onClick={logOutput('picture')}>
                    Save
                </Button>
            </AccordionActions>
      </Accordion>
      ...
      <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
            <AccordionSummary
                ...
                id="panel1bh-header"
                >
                <Typography className={classes.heading}>Place Holder</Typography>
            </AccordionSummary>

            <AccordionDetails>
                <Typography>
                    Implement other Customizations.
                </Typography>
            </AccordionDetails>
      </Accordion>
    </div>
